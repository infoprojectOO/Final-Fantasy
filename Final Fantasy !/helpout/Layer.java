...
public class Layer extends JPanel
    ...
    private static final int XFUDGE = 30;
    private static final int YFUDGE = 30;

    //Initial layer of dukeLabel.
    private static final int INITIAL_DUKE_LAYER_INDEX = 1;

    public Layer(JLayeredPane layeredPane)    {
        ...
        //JLabel label = createColoredLabel("green",Color.green, new Point(150,100));
        //layeredPane.add(label,new Integer(302));
        JPanel panel = new JPanel();
        panel.add(createColoredLabel("green",Color.blue, new Point(150,100)));
        layeredPane.add(panel, new Integer(303));
    ...
    private static void createAndShowGUI() {
        ...
        Layer newContentPane = new Layer(
